...
\begin{document}
	...
	% 	In this paper, a level-0 driver/vehicle treats the other vehicles at the intersection as stationary obstacles, and selects its action sequence, γ��0, accordingly. In this setting, a level- 0 driver/vehicle may represent an aggressive driver in real traffic, who usually assumes that other drivers will yield the right of way.
