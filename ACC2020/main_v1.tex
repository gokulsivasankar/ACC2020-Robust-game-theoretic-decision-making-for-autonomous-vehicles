...
\begin{document}
	...
	\begin{figure}
		\begin{centering}
			...
			\node (xlabel) [below = 1cm of fig, inner sep = 0pt] {\Large Time (s)};
		
			\node (ylabel) [left = 0.25cm of fig, inner sep = 0pt] {\large $t=0$};
	...
	We would like to express out appreciation to the Nan Li who provided expertise that greatly assisted the research and it should be noted that the code publicly available (\url{https://github.com/gokulsivasankar/RobustDecisionMaking}) is based on his previous study \cite{Li2018}.
