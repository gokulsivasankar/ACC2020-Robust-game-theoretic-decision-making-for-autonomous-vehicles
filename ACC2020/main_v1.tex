...
\begin{document}
	...
	In order to incorporate the multi-model strategy in the decision making process and select the optimal action according to the model of each agent, the expected cumulative reward for a given sequence of action, is given by


	
	, and selects optimal actions according to the model of each of the drivers it is interacting with.
