...
\begin{document}
	...
	\begin{abstract}
		...
		In a typical traffic scenario, autonomous vehicles are required to share the road with other road participants, e.g., human driven vehicles, pedestrians, etc. To successfully navigate the traffic, \textcolor{blue}{an adaptive level-\textit{k} framework }%a cognitive hierarchy theory such as level-k framework, 
